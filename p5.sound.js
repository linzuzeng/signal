...
fft = function () {
   ...
   *  two types of analyses: <br> 鈥� <code>FFT.waveform()</code> computes
   *  amplitude values along the time domain. The array indices correspond
   *  to samples across a brief moment in time. Each value represents
   *  amplitude of the waveform at that sample of time.<br>
   *  鈥� <code>FFT.analyze() </code> computes amplitude values along the
...
looper = function () {
   ...
   *  this phrase will call at every step鈥攆or example it might be
